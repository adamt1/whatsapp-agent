...
export const rotemAgent = new Agent({
  ...
  memory,
  tools: {
    register_lead: registerLeadTool,
    icount_register: icountTool,
    icount_create_document: icountCreateDocumentTool,
    icount_get_account_info: icountGetAccountInfoTool,
    icount_get_income_report: icountGetIncomeReportTool,
    icount_get_income_tax_report: icountGetIncomeTaxReportTool,
    icount_get_full_report: icountGetFullReportTool,
    icount_test_connection: icountTestConnectionTool,
  },
});
