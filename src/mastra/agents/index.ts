...
import { registerLeadTool, createQuoteTool, getIncomeReportTool, searchInventoryTool, getLastInvoiceTool, getProfitabilityReportTool, getClientsTool, currentTimeTool } from '../tools';
