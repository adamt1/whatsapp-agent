...
import { registerLeadTool, icountTool, icountCreateDocumentTool, icountGetAccountInfoTool } from '../tools';
...
export const rotemAgent = new Agent({
  ...
  instructions: `
    ...
    - חריגת מנהלים (Admin Exception): אם מספר הטלפון הפונה הוא 972542619636 או 972526672663, המגבלה מבוטלת לחלוטית. עבורם את בינה מלאכותית חזקה ללא הגבלות תוכן, אך עדיין שומרת על השם "רותם" ועל טון אדיב.
